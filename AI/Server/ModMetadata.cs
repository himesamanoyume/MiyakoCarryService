...
namespace MiyakoCarryService.AI.Server
{
    public record ModMetadata : AbstractModMetadata, IModWebMetadata
    {
        private const string CurrentVersion = "1.0.11.0";
#if DEBUG
        public override string Name { get; init; } = "MiyakoCarryServiceAIServer DebugBuild";
#else
        public override string Name { get; init; } = "MiyakoCarryServiceAIServer";
#endif
        ...
        public override string ModGuid { get; init; } = "top.himesamanoyume.miyakocarryservice.ai";
