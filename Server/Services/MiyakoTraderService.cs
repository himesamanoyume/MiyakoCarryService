...
namespace MiyakoCarryService.Server.Services
{
    ...
    public sealed class MiyakoTraderService(
        ModHelper modHelper,
        ICloner cloner,
    ...
    {
        private readonly string traderDir = System.IO.Path.Join(MiyakoCarryServiceConfig.GetModPath(), "Assets", "database", "traders", "687345e3bcf2abcd12345678");
        ...
        {
            var iconPath = System.IO.Path.Join(traderDir, "miyako.jpg");
            ...
            AddTraderToLocales(traderBase, "Miyako", "This is the miyako carry service.");
            var assort = modHelper.GetJsonDataFromFile<TraderAssort>(traderDir, "assort.json");
