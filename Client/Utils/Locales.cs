namespace MiyakoCarryService.Client.Utils
{
    public static class Locales
    {
        ...
        public const string REPORTABOUTENEMY_NAME = "Mcs/ReportAboutEnemy Name";
        public const string REPORTABOUTENEMY_TARGETNAME = "Mcs/ReportAboutEnemy TargetName";
        public const string TEAMREPORTABOUTENEMY_NAME = "Mcs/TeamReportAboutEnemy Name";
        public const string TEAMREPORTABOUTENEMY_TARGETNAME = "Mcs/TeamReportAboutEnemy TargetName";
        public const string REGROUP_NAME = "Mcs/Regroup Name";
        public const string REGROUP_TARGETNAME = "Mcs/Regroup TargetName";
        public const string TEAMREGROUP_NAME = "Mcs/TeamRegroup Name";
        public const string TEAMREGROUP_TARGETNAME = "Mcs/TeamRegroup TargetName";
        public const string GOTOPOINT_NAME = "Mcs/GoToPoint Name";
        public const string GOTOPOINT_TARGETNAME = "Mcs/GoToPoint TargetName";
        public const string TEAMGOTOPOINT_NAME = "Mcs/TeamGoToPoint Name";
        public const string TEAMGOTOPOINT_TARGETNAME = "Mcs/TeamGoToPoint TargetName";
        public const string HOLDPOSITION_NAME = "Mcs/HoldPosition Name";
        public const string HOLDPOSITION_TARGETNAME = "Mcs/HoldPosition TargetName";
        public const string TEAMHOLDPOSITION_NAME = "Mcs/TeamHoldPosition Name";
        public const string TEAMHOLDPOSITION_TARGETNAME = "Mcs/TeamHoldPosition TargetName";
